...
const AdminPanel = () => {
    ...
    const handleAuthenticate = async () => {
        ...
        setLoading(true);
        const { response, err } = await adminApi.getStats(secret);
        setLoading(false);
    ...
    if (!isAuthenticated) {
        return (
            <Flex direction="column" align="center" justify="center" p={8} h="full">
                <SEO
                    title="Admin Panel"
                ...
                <VStack
                    ...
                    w="full"
                >
                    <Heading size="md" color="fg.default">Admin Authentication</Heading>
    ...
    return (
        <Flex direction="column" p={{ base: 4, md: 8 }} gap={8} w="100%" bg="bg.canvas" minH="100vh">
            ...
            <Flex justify="space-between" align="center" mb={4}>
                ...
                <Button size="sm" colorScheme="red" variant="outline" onClick={handleLogout} borderRadius="full" px={6}>
                    Lock Panel
                </Button>
            </Flex>
